/**
 * API Configuration
 * All API URLs should be configured via environment variables in .env file
 * 
 * Create a .env file in the root directory with:
 * REACT_APP_API_BASE_URL=https://api.learningbix.com:8112
 * REACT_APP_API_TIMEOUT=10000
 * REACT_APP_API_WITH_CREDENTIALS=false
 * 
