          ...
          <div className="flex items-end gap-3 flex-1 min-w-[200px]">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className={`w-full px-4 py-2.5 rounded-lg font-bold text-sm transition-all ${selectedAgeGroup === 'playgroup'
          ...
          <div className="flex items-end gap-3 flex-1 min-w-[200px]">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className={`w-full px-4 py-2.5 rounded-lg font-bold text-sm transition-all ${selectedAgeGroup === 'nursery'
                    ? 'bg-[#ff6b35] text-white'
                    : 'bg-white text-black border-2 border-gray-300 hover:border-gray-400'
                  }`}
              >
          ...
          <div className="flex items-end gap-3 flex-1 min-w-[200px]">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className={`w-full px-4 py-2.5 rounded-lg font-bold text-sm transition-all ${selectedAgeGroup === 'juniorKG'
                    ? 'bg-[#ff6b35] text-white'
                    : 'bg-white text-black border-2 border-gray-300 hover:border-gray-400'
                  }`}
              >
          ...
          <div className="flex items-end gap-3 flex-1 min-w-[200px]">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className={`w-full px-4 py-2.5 rounded-lg font-bold text-sm transition-all ${selectedAgeGroup === 'seniorKG'
                    ? 'bg-[#ff6b35] text-white'
                    : 'bg-white text-black border-2 border-gray-300 hover:border-gray-400'
                  }`}
              >
